...
class Scenario(BaseScenario):
    def __init__(self, n_good=4, n_adv=4, n_landmarks=0, n_food=4, n_forests=0, alpha=1, sight=100, no_wheel=False, ratio=1, food_ratio=None):
        self.n_good = n_good
        self.n_adv = n_adv
    ...
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            ...
            agent.typename = "adv" if i < num_adversaries else "good"
